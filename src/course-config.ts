...
//
// The code's last three digits (699) were assigned to this repo when it was
// provisioned, and no other course in the cohort has them — keep them fixed.
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP3699",
  title: "League Studies",
  session: "Semester 1",
  year: 2027,
  level: 3,
  ...
  endDate: "2027-05-28",
  description:
    "League Studies teaches students to read a League of Legends match: how " +
    "resources, information, space, tempo and composition turn individual " +
    "decisions into wins and losses. The recurring question: why did this " +
    "team win?",
  tags: ["esports analysis", "game studies", "strategy"],
